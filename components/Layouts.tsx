...
function PageLayout({ children }: LayoutProps) {
    return (
        <>
            <div className="flex justify-center pt-2  w-full">{children}</div>
        </>
    )
}
    ...
    return (
        <div className="relative z-0 min-h-screen">
            <div className="absolute inset-0 -z-10 overflow-hidden ">
                <div className=" bg absolute inset-y-0 left-1/2 w-[100vw] min-w-[1500px] -translate-x-1/2 bg-no-repeat" />
            </div>
            {children}
        </div>
    )
