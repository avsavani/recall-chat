      ...
      <div className="mt-2 flex w-full rounded-md">
        ...
        >
          <Textarea
            ...
            className={cn(
              "Textarea w-full pl-6 text-lg font-semibold",
...
//           "before:border before:border-black-500/40 before:opacity-0 before:ring-2 before:ring-black-300/20  before:transition ",
//           "dark:before:border-black-400/40 dark:before:ring-black-900/20",
//           " after:pointer-events-none after:absolute after:inset-px after:rounded-[7px] after:shadow-white/5 after:transition",
//           "focus-within:before:opacity-100 focus-within:after:shadow-black-500/100 dark:after:shadow-white/5 dark:focus-within:after:shadow-black-500/20"
//         )}
//       >
//         <input
//           className={cn(
//             " input-shadow rounded-lg  !outline-none",
//             "relative border border-black/5 px-7 py-3.5 text-base shadow-black/5  placeholder:text-neutral-400 ",
  ...
  ({ className, children, ...props }, ref) => {
    return (
      <div className="mt-2 flex w-full rounded-md ">
        <div
          className={cn(
            " relative w-full before:pointer-events-none before:absolute before:-inset-1 before:rounded-[9991px] before:border before:border-black-500/20 before:opacity-0 before:transition dark:before:border-black-400/80 dark:before:ring-2 dark:before:ring-indigo-900/40",
            ...
            "focus-within:before:opacity-100 focus-within:after:shadow-black-500/100 dark:after:shadow-white/5 dark:focus-within:after:shadow-black-500/30"
          )}
        >
          <input
            type="search"
...
export { Input, InputButton, TextArea }
