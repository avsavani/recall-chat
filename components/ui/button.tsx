...
const GlowButton = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, disabled, size, ...props }, ref) => {
    return (
      <div
        className={cn(
          " relative w-full before:pointer-events-none before:absolute before:-inset-1 before:rounded-[11px] before:border before:border-black-500/20 before:opacity-0   before:transition dark:before:border-black-400/70 dark:before:ring-2 dark:before:ring-black-900/40",
          ...
          !disabled &&
          "hover:before:opacity-100 hover:after:shadow-black-500/100  dark:hover:after:shadow-black-500/20"
        )}
      >
        <button
          className={cn(
